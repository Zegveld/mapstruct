...
public interface InheritanceSubclassMapper {
    InheritanceSubclassMapper INSTANCE = Mappers.getMapper( InheritanceSubclassMapper.class );
    ...
    VehicleDto mapInherited(Vehicle vehicle);
}
